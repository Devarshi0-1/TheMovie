...
* [ ] **Vite+ workspace** with **oxlint** (lint), **oxfmt** (format), **Vitest** (test), **tsgo v7** (type-check). Pin versions. _(frontend app — next)_
* [ ] **TanStack Start + React 19** app; file-based **TanStack Router** (ships with Start); **TanStack Query** for server state. _(frontend app — next)_
