...
### Milestone 10.4: Chat agent TV parity
* [ ] **TV-aware retrieval tools** (+ `mediaType` on `manage_watchlist`), wired into the agent loop.
* [ ] **Intent gate + system prompt** updated to treat TV queries as on-topic; **recommendations** seed from TV watchlist entries too.
